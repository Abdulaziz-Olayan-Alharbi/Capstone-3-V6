...
public class ShippingController {
    ...
    public ResponseEntity deliverOrder(@PathVariable Integer shippingId){
        shippingService.deliverOrder(shippingId);
        return ResponseEntity.ok("Order delivered successfully");
    }

    @PutMapping("/assign/{shippingId}/{shipperName}")
    public ResponseEntity assignShipping(@PathVariable Integer shippingId, @PathVariable String shipperName) {
        shippingService.assignShipper(shippingId, shipperName);
        return ResponseEntity.ok("Shipping assigned successfully");
    }
}
